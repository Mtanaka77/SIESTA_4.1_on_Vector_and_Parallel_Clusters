...
It is very important that generic gfortran compiler must be used throughout the configure and make steps. The PGI fortran is not compatible with the SIESTA code; moreover, "fortran" points to different compilers in other cases !
